...
while t <= Max_iteration
   ...
   for do=1:1:variable
    ...
    fdbIndex = fitnessDistanceBalance( sol, fitt );
    for dw=1:1:student
       % Best Student
         ...
         % Good Student
          ...
          % Average Student
                if rand>an
                    ...
                    if rand < 0.3
                        par1(dw,do)=sol(fdbIndex,do)+(rand*(mean(1,do)-par(dw,do)));      % Equation (3)
                    else
           ...
           % Students who improves randomly
                    if rand < 0.7
                        par1(dw,do)=sol(fdbIndex,do)+(rand*(maxi(do)-mini(do)));                    % Equation (4)
                    else
